...
start:
   ...
   lcall   init           
; initialize hardware          ; print Emmanuel HAVUGIMANA --copy-pasted
   lcall   print          ; print welcome message
   .db 0ah, 0dh, "Welcome to 6.115!", 0ah, 0dh,"ehavugi> ", 0h
monloop:
...
pattern:
	lcall delay ; wait for a quarter of second 
	lcall delay
	lcall delay
	lcall delay ; probably a loop to capture seconds can added
	mov A,P1
	RRC A; make first led on ; rightmost
	mov P1,A
	;mov P1,A
	lcall delay ; wait for a quarter of second 
	lcall delay
